...
class mSEModule(nn.Module):
    ...
    def forward(self, x):
        ...
        reshape_bottleneck = bottleneck.view(-1, self.n_segment, bottleneck.size()[1], bottleneck.size()[2], bottleneck.size()[3])  # n, t, c//r, h, w
        ...
        reshape_conv_bottleneck = conv_bottleneck.view(-1, self.n_segment, conv_bottleneck.size()[1], conv_bottleneck.size()[2], conv_bottleneck.size()[3])  # n, t, c//r, h, w
        ...
        diff_fea_pluszero_forward = F.pad(diff_fea_forward, self.pad1_forward, mode="constant",
                                          value=0)  # n, t, c//r, h, w
        diff_fea_pluszero_forward = diff_fea_pluszero_forward.view(-1, diff_fea_pluszero_forward.size()[2], diff_fea_pluszero_forward.size()[3], diff_fea_pluszero_forward.size()[4])  # nt, c//r, h, w
        diff_fea_pluszero_backward = F.pad(diff_fea_backward, self.pad1_backward, mode="constant",
                                           value=0)  # n, t, c//r, h, w
        diff_fea_pluszero_backward = diff_fea_pluszero_backward.view(-1, + diff_fea_pluszero_backward.size()[2], + diff_fea_pluszero_backward.size()[3], + diff_fea_pluszero_backward.size()[4])  # nt, c//r, h, w
